...
@Component({
  selector: 'app-teacher-profile-sidebar',
  templateUrl: './teacher-profile-sidebar.component.html',
  styleUrls: ['./teacher-profile-sidebar.component.css']
})
export class TeacherProfileSidebarComponent implements OnInit {
