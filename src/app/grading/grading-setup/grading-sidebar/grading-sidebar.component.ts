...
@Component({
  selector: 'app-grading-sidebar',
  templateUrl: './grading-sidebar.component.html',
  styleUrls: ['./grading-sidebar.component.css']
})
export class GradingSidebarComponent implements OnInit {
