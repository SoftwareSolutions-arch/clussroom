...
@Component({
  selector: 'app-class-sidebar',
  templateUrl: './class-sidebar.component.html',
  styleUrls: ['./class-sidebar.component.css']
})
export class ClassSidebarComponent implements OnInit {
