...
@Component({
  ...
  styleUrls: ['./learner-assignment-review.component.css']
})
export class LearnerAssignmentReviewComponent implements OnInit {
  ...
  constructor(private service: SharedServiceService,private httpClient:HttpClient,private util: UtilService,private router: Router,private route: ActivatedRoute) { 
 ...
 saveQuestions(){
  ...
  // for back page
backPage(){
  this.router.navigate(['/class-material/continue-learner'], { queryParams: { id: this.id} });  
}
