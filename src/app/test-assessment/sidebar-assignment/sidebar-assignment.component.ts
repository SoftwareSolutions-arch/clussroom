...
@Component({
  selector: 'app-sidebar-assignment',
  templateUrl: './sidebar-assignment.component.html',
  styleUrls: ['./sidebar-assignment.component.css']
})
export class SidebarAssignmentComponent implements OnInit {
